...
const Home = () => {
  ...
  const SummerInternship = [
    {
      ...
      description:
        "Conducted market research and analyzed investment deals in the chemical sector. Prepared investment teasers and pitch books to support M&A and funding deals. Engaged in client meetings, contributing to the facilitation of strategic investment decisions.",
    },
  ];  
  ...
  const skills = [
    {
      ...
      description: "Extract, Transform, Load, Dashboards, Reports",
    },
    {
      title: "SQL & Database Management",
      description: "MYSQL, PostgreSQL, Data Warehousing",
    },
    {
      title: "Financial Analysis & Modeling",
      description: "Valuation, M&A, Financial Statements, Excel",
    },
    {
      title: "Python & Data Analysis",
      description: "Pandas, NumPy, Data Cleaning, Visualization, Automation with selenium, Tikinter",
    },
    {
      title: "SAP",
      description: "MM, SD, FICO",
    },
    {
  ...
  const handleDownloadResume = () => {
    ...
    fetch("/SAI TEJA DONGA_RESUME.pdf").then((response) => {
      response.blob().then((blob) => {
        ...
        alink.href = fileURL;
        alink.download = "SAI TEJA-Resume.pdf";
        alink.click();
      });
    });
  };
      ...
      >
        ...
        >
          <div className='flex-1 text-center md:text-left'>
            ...
            >
              <TextGenerateEffect words='An Engineer with MBA' />
            </motion.h2>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            {[
              {
                ...
                text: "donga.saiteja2604@gmail.com",
                href: "mailto:donga.saiteja2604@gmail.com",
              },
              {
              ...
              },
              {
                ...
                href: "https://www.linkedin.com/in/saitejadonga/",
              },
            ]?.map((contact, index) => (
              <motion.div
                key={contact.text}
